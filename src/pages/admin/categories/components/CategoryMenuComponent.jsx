    ...
    return (
        <div className="col-span-1 flex items-center">
            ...
            <div className="flex flex-col space-y-4 md:flex-row md:justify-between md:items-center w-full">
                ...
                {/* Add Category opening modal div */}
                <div style={{ background: "#303031" }} className="cursor-pointer rounded-full p-2 flex items-center justify-center text-gray-100 text-sm font-semibold uppercase" onClick={() => setIsAddCategoryModal(true)}>
